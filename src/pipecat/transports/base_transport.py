...
class TransportParams(BaseModel):
    ...
    Parameters:
        ...
        bot_vad_stop_secs: Fallback timeout before emitting BotStoppedSpeakingFrame
            when the output queue drains without an explicit TTSStoppedFrame.
